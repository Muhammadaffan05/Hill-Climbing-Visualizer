...
def stochastic_hill_climbing(initial_position, step_size, max_iter):
...
best_position, objective_values = stochastic_hill_climbing(initial_position, step_size, max_iter)
...
t.penup()
t.goto(0, 200)
t.write('Stochastic Hill Climbing', align='center', font=('Arial', 20, 'bold'))
t.goto(0, -200)
